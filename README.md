# robolectric-ant-sample [![Build Status](https://travis-ci.org/friederbluemle/robolectric-ant-sample.png?branch=master)](https://travis-ci.org/friederbluemle/robolectric-ant-sample) #
